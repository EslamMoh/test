...
class BillingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing" do
    assert_difference('Billing.count') do
      post billings_url, params: { billing: { amount: @billing.amount, reciep_id: @billing.reciep_id, token: @billing.token } }
    end
  ...
  test "should update billing" do
    patch billing_url(@billing), params: { billing: { amount: @billing.amount, reciep_id: @billing.reciep_id, token: @billing.token } }
